        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="<?php echo site_url('dashboard/guru'); ?>">
                            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('soal/guru'); ?>">
                            <i class="fa fa-copy"></i> <span>Soal</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('ujian/hasil_guru'); ?>">
                            <i class="fa fa-star-o"></i> <span>Hasil</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('ujian/analisa_guru'); ?>">
