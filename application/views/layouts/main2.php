                        ...
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    ...
                                    <?php
                                    $data = $this->db->get_where('notif',array('nis'=>$this->session->userdata('nis')))->row_array();
                                    ?>
                                    <ul class="menu">
                                        <li>
                                            <a href="<?php echo site_url('pengumuman/daftar_ulang') ?>">
                                                <i class="fa fa-warning text-yellow"></i> Anda berhasil diterima cek disini
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo site_url('resources/img/lg.png');?>" class="user-image"
                                    alt="User Image">
                                <span class="hidden-xs"><?php echo $this->session->userdata('nis'); ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p><?php echo $this->session->userdata('nis'); ?></p>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="<?php echo site_url('dashboard/siswa');?>">
                            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('pendaftar/index/'.$this->session->userdata('nis')) ?>">
                            <i class="fa fa-copy"></i> <span>Pendaftaran</span>
                        </a>
                    </li>
                    <li>
