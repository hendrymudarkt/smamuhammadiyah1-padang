    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Jadwal Edit</h3>
            </div>
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="date" name="jadwal" value="<?php echo $jadwal['jadwal']; ?>" class="form-control" id="jadwal" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <select name="jenis_soal" class="form-control">
                                <option value="<?php $jadwal['jenis_soal'] ?>"><?php $jadwal['jenis_soal'] ?></option>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <select name="status" class="form-control">
                                <option value="<?php $jadwal['status'] ?>"><?php $jadwal['status'] ?></option>
